...
// //Quando a var eletrodm receber o valor, o switch vai selecionar o case e o texto vai ser mostrado na linha.
// switch (eletrodm){
//     case 'Eletrodoméstico':
//         getElementById('estoque').innerHtml = "Valor total do estoque de Eletrodoméstico é " (price*quantity);
//     break;
//     case 'Panelas':
//         getElementById('estoque').innerHtml = "Valor total do estoque de Panelas é " (price*quantity);
//     break;
//     case 'Acessórios':
//         getElementById('estoque').innerHtml = "Valor total do estoque de Acessórios é " (price*quantity);
//     break;
//     case 'Eletrônicos':
//         getElementById('estoque').innerHtml = "Valor total do estoque de Eletrônicos é " (price*quantity);
//     break;
// } 
